...
<head>
	...
	<title>Little Reminder : Forbidden</title>
...
<div id="header">
	...
	<div id="breadCrumb"><a href='/'>Home</a> :: Forbidden</div>
...
<div id="wrapperBody"><!-- sets background to white and creates full length leftcol-->
	...
	<div id="wrapperfooter"><!-- sets background to white and creates full length rightcol-->
    	...
    	<div id="centercolumnText" class="ui-corner-all"><!-- begin centercolumn -->
			...
			<h2> Error 403 - You are not permitted access to this location</h2>

			<h3>Access to  
			<?php print ($_ENV["SCRIPT_URL"]); ?>	
			 is forbidden. </h3><h3>This is a security feature of our server, do not be alarmed</h3>
			 <br/><br/>
			 <h4>Go to the <a href="/index.html">Home Page</a> you are allowed there;-).</h4><br/><br/><br/>
